...
class User{
    ...
    public static function find_users_byId($user_id)
    {
        global $database;
    ...
    {
        //get_object_vars returns every properties of this class even it is private or public
    ...
    public function update()
    {
        ...
        " WHERE id={$database->escape($this->id)}";
        $database->query($sql);
